...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 115_06-exercise-1_cheked_space_invader) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Exercise: 115
;
;   Use the predicates from exercise 114 to check
;
;     1. the space invader world program,
;     2. the virtual pet program (exercise 108),
...
(check-expect (sigs_or_not? (make-aim (make-posn 5 50)  (make-tank 10 5)))   true)
(check-expect (sigs_or_not? (make-fired (make-posn 50 50)
                                        (make-tank 50 1)
                                        (make-posn 30 20))) true)
