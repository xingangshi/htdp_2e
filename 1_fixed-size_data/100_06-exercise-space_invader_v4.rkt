...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 100_06-exercise-space_invader_v4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Exercise 99: 
;
;   Design the function si-move, which is called for every clock tick. Accordingly it consumes an
;   element of SIGS and produces another one. Its purposes is to move all objects according to their velocity.
;
;   ...
;
