...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 076_05-exercise-formulate_struct_define_2) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp")) #f)))
; Exercise 76: 
;
