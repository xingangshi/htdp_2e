...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 115_06-exercise-3_checked_editor) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Exercise: 115
;
...
; Any -> Boolean
; returns true if eds is an Editor
(check-expect (editor_or_not? (run "hello")) true)
(check-expect (editor_or_not? "hello") false) 

(define (editor_or_not? eds)
  (cond
    [(editor? eds) true]
    [else false]))
